...
Investor4 = VentureCapitalist.new("Oprah", 5500000000)
Investor5 = VentureCapitalist.new("Martha", 500000000)
...
FundingRound5 = FundingRound.new(Company5, Investor5, "Series C", 500)
FundingRound6 = FundingRound.new(Company1, Investor2, "Seed", 150)
FundingRound1 = FundingRound.new(Company1, Investor1, "Angel", 100)
